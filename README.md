...
NetScan Enterprise is a high-performance asynchronous network discovery tool built for internal enterprise environments.

It combines ICMP discovery, ARP inspection, TCP scanning, banner grabbing, and asset fingerprinting into a clean, modular framework designed for professional network visibility.

---

## 🚀 Overview

NetScan Enterprise is part of the **NetTools Portfolio** by Humbug Software.
...
These can be modified in core/scanner.py.
...
NetScan Enterprise is intended for authorized internal network environments only.
